...
// Sidebar e SEMPRE fixa: h-screen, overflow:hidden, shrink-0
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside
      className="w-64 bg-black/40 backdrop-blur-2xl text-slate-400 flex flex-col border-r border-white/5 shrink-0"
